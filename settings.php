...
<html>
<head>
	<title>ShopKita - Pengaturan</title>
...
<body style="background-image: url(image/homebackgrndimg1.jpg);">
	...
	<div class="container">
			<div class="signupform_content">
				<div class="header" style="font-size: 60px; color: #fff; margin: 0 0 5px 0; text-align:center; margin-bottom: 40px; margin-top: 60px">
					Pengaturan
				</div>
			</div>
		</div>
