...
<html>
<head>
	<title>ShopKita - Keranjang</title>
						...
						echo '
							...
							<div class="signupform_text"></div>
								...
								<form action="" method="POST" class="registration">
									...
									<h3 style="color:red;font-size:18px; padding: 5px;">Hanya Menerima Cash On Delivery saja.</h3>
										<div>
											<td>
										...
										<div>
											<input onclick="myFunction()" name="order" class="uisignupbutton signupbutton" type="submit" value="Konfirmasi Pembelian">
										</div>
